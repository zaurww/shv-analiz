...
- Строка 5: отступ
- Строки 6-7: двойной заголовок (группа + подзаголовок)
- Строки данных: активный KYB → красный фон; активный SYB → фиолетовый фон
...
4. Файл ~1185 строк — просите Claude редактировать конкретные секции, а не переписывать всё
